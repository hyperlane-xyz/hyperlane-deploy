...
anvil --chain-id 31337 -p 8545 --block-time 1 --state ./artifacts/anvil1/state > /dev/null &
ANVIL_1_PID=$!

anvil --chain-id 31338 -p 8555 --block-time 1 --state ./artifacts/anvil2/state > /dev/null &
ANVIL_2_PID=$!
